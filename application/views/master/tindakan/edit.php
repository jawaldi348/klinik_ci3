<div id="modal_edit" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('tindakan/update', ['id' => 'form_create']) ?>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label">Kode</label>
                    <input type="text" name="kode" id="kode" class="form-control" placeholder="Kode" value="<?= $data['kd_tindakan'] ?>" readonly>
                </div>
                <div class="form-group">
                    <label class="control-label">Nama Tindakan</label>
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Tindakan" value="<?= $data['nm_tindakan'] ?>">
                </div>
                <div class="form-group">
                    <label class="control-label">Harga Paket (Rp)</label>
                    <input type="text" name="harga" id="harga" class="form-control" placeholder="Harga Paket (Rp)" value="<?= $data['harga'] ?>">
                </div>
            </div>
